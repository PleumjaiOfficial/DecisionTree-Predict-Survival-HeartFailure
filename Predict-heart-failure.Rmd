...
-   4.Model Explanation and Model Evaluation
...
LOOCV same technicial like K-FLOD. the different is number of split is the record of data and split with one set for test and other for train to build model
